...
class Demo extends Component {
  ...
  handleSwitchOneChecked = () => {
    this.setState({ ...this.state, oneChecked: !this.state.oneChecked })
  }
  handleSwitchTwoChecked = () => {
    this.setState({ ...this.state, twoChecked: !this.state.twoChecked })
  }
    ...
    return (
      <div>
        ...
        <Switch
          ...
          onClick={this.handleSwitchOneChecked} />
